    ...
    public class Beautify : MonoBehaviour {
       ...
       _bloomBoost5 = 0f;
        ...
        Material
								...
								const string BEAUTIFY_BUILD_HINT = "BeautifyBuildHint53";
								...
								FilterMode filterModeDoF = FilterMode.Bilinear;
								...
								void OnPreCull () {	// Aquas issue with OnPreRender
												...
												if (dofCurrentLayerMaskValue != _depthOfFieldExclusionLayerMask.value) shouldUpdateMaterialProperties = true;
								...
								void OnRenderImage (RenderTexture source, RenderTexture destination) {
												...
												if (_depthOfField) {
																...
																if (Camera.current != sceneCamera) {
																				...
																				RenderTexture rtDB = RenderTexture.GetTemporary (rtDofDescriptor);
																				rtDB.filterMode = filterModeDoF;
								...
								void BlurThisDoF (RenderTexture rt, int renderPass) {
												...
												rt2.filterMode = filterModeDoF;
												rt3.filterMode = filterModeDoF;
								...
								void UpdateMaterialPropertiesNow () {
												...
												if (_depthOfField) {
																...
																filterModeDoF = _depthOfFieldExclusionLayerMask.value != 0 ? FilterMode.Point : FilterMode.Bilinear;
												}
												if (_eyeAdaptation) {
